...
contract Owned {
    ...
    event OwnershipTransferredEvent(address indexed _from, address indexed _to);
    ...
    function acceptOwnership() public {
        ...
        emit OwnershipTransferredEvent(owner, newOwner);
        owner = newOwner;
        newOwner = address(0);
    }
}
...
contract bitfwdToken is ERC20Interface, Owned, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        emit  TransferEvent(msg.sender, to, tokens);
        return true;
    }
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        emit ApprovalEvent(msg.sender, spender, tokens);
        return true;
    }
    ...
    function transferFrom(address from, address to, uint tokens) public returns (bool success) {
        ...
        balances[to] = safeAdd(balances[to], tokens);
        emit TransferEvent(from, to, tokens);
        return true;
    }
    ...
    function() public payable {
        ...
        emit TransferEvent(address(0), msg.sender, tokens);
